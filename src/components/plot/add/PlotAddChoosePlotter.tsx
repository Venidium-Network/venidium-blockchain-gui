...
import { CardStep, Select } from '@venidium/core';
import {
  FormControl,
  FormHelperText,
  Grid,
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Venidium Proof of Space plotter. If unsure,
            use the default Venidium Proof of Space plotter.
        </Trans>
      </Typography>
