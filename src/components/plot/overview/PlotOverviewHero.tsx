...
import { CardHero, Flex, Link } from '@venidium/core';
import { PlotHero as PlotHeroIcon } from '@venidium/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Venidium. '
              }
              <Link
                target="_blank"
                href="https://github.com/Venidium-Network/venidium-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
