...
import {
  ...
  Fee,
  Form,
  TextField as VenidiumTextField,
  AlertDialog,
  CopyToClipboard,
  Flex,
  Card,
...
import { /* ray_to_venidium_string, */ venidium_to_ray } from '../../../util/venidium';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {ray_to_venidium_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of venidium in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Venidium that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Venidium that you have just spent but is not
...
function SendCard(props: SendCardProps) {
  ...
  function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send venidium to coloured address. Please enter a venidium
              address.
            </Trans>
          </AlertDialog>,
        ),
    ...
    if (address.slice(0, 12) === 'venidium_addr://') {
    ...
    const amountValue = Number.parseFloat(venidium_to_ray(amount));
    const feeValue = Number.parseFloat(venidium_to_ray(fee));
