...
import { Card, CopyToClipboard, Flex, Table } from '@venidium/core';
import type { Row } from '../core/components/Table/Table';
import {
  ray_to_venidium_string,
  ...
  },
  {
    field: (row: Row) =>
      type === WalletType.COLOURED_COIN
        ? ray_to_colouredcoin_string(row.amount)
        : ray_to_venidium_string(row.amount),
    title: <Trans>Amount</Trans>,
  },
  {
    field: (row: Row) => ray_to_venidium_string(row.fee_amount),
