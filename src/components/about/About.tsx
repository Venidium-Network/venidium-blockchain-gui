...
import icon from '../../assets/img/venidium_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Venidium Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Venidium-Network/venidium-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
